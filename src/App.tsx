...
const positionPlacements = {
  ...
  'SALES OFFICER - CMO': [
    ...
    'ADIRA KETAPANG',
    'ADIRA PONDOK GEDE',
    'ADIRA BEKASI 1 GRANDMALL -BEKASI RAYA',
    'ADIRA RO BANTAR GEBANG -BEKASI RAYA',
    'ADIRA BEKASI 2 TAMBUN -BEKASI RAYA',
    'ADIRA BEKASI 3 CAR -BEKASI RAYA',
    'ADIRA BEKASI 4 HARAPAN INDAH -BEKASI RAYA',
    'ADIRA BEKASI 5 CAR -BEKASI RAYA',
    'ADIRA CIKARANG -BEKASI RAYA',
    'ADIRA BOGOR 1 TAJUR -BOGOR RAYA',
    'ADIRA BOGOR 2 CAR TAJUR -BOGOR RAYA',
    'ADIRA BOGOR 3 SOLEH ISKANDAR -BOGOR RAYA',
    'ADIRA RO PARUNG -BOGOR RAYA',
    'ADIRA BOGOR LEUWILIANG -BOGOR RAYA',
    'ADIRA RO PARUNG PANJANG -BOGOR RAYA',
    'ADIRA SAWANGAN -BOGOR RAYA',
    'ADIRA CIMANGGIS -DEPOK RAYA',
    'ADIRA DEPOK MARGONDA -DEPOK RAYA',
    'ADIRA DEPOK CAR -DEPOK RAYA',
    'ADIRA CIBINONG -DEPOK RAYA',
    'ADIRA RO GUNUNG PUTRI -DEPOK RAYA',
    'ADIRA CILEUNGSI CAR -DEPOK RAYA',
    'ADIRA CILEUNGSI -DEPOK RAYA',
    'SMS FINANCE JAKARTA TIMUR',
    'SMS FINANCE JAKARTA UTARA'
  ],
  'COLLECTION REMEDIAL OFFICER ( COLLECTION )': [
    'ADIRA TEBET MOTOR',
    'ADIRA TEBET MOBIL',
    'ADIRA KELAPA GADING MOTOR',
    'ADIRA KELAPA GADING MOBIL',
